...
class KalenderHistoryButton extends HookConsumerWidget {
  const KalenderHistoryButton({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    ref.watch(absenControllerProvider);
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () async {
            ...
            if (picked != null) {
              final coba = await ref
                  .read(absenControllerProvider.notifier)
                  .getHistoryByDate(DateFormat('yyyy-MM-dd').format(picked));
